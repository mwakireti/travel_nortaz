            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        <h2>CANOEING & BIRDWATCHING.</h2>
                        <ul>
                            <li><a href="index.html">Home</a></li>
                            <li><span><i class="fas fa-circle"></i></span><a href="tour-search.html">Safari</a></li>
                            <li><span><i class="fas fa-circle"></i></span> CANOEING & BIRDWATCHING.</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tour_details_leftside_wrapper">
                        <div class="tour_details_heading_wrapper">
                            <div class="tour_details_top_heading">
                                ...
                                <h5><i class="fas fa-map-marker-alt"></i> CANOEING & BIRDWATCHING.
                                </h5>
                            </div>
                        ...
                        <div class="tour_details_boxed">
                            ...
                            <div class="tour_details_boxed_inner">
                                <p> Spending a day at Lake Duluti, located a bit outside Arusha town, will bring the sense of relaxation and rolling day, surrounded by the beautiful voices of hundreds of different types of bird species and a scenic view of Mt. Meru.
                                    Here you will be able to take a canoeing trip around the lake that takes around 30min, take a walk around the lake though the tropical rainforest while learning and watch different bird species or a short hike on the closest hill that you will appreciate the astonishing view of Arusha city.</p>
                                <!-- <p>
