...
<head>
    ...
    <!-- Title -->
    <title> Climb & Trekk - Tour Packages </title>
    <!-- Bootstrap css -->
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="section_heading_center">
                        <h2>Available Climb & Trekk tours</h2>
                    </div>
                </div>
            </div>
            <!-- <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="theme_common_box_two img_hover">
                                <div class="theme_two_box_img">
                                    <a href="tour-details.html"><img src="assets/img/tab-img/Freedom kili .png" alt="img"></a>
                                    <p><i class="fas fa-map-marker-alt"></i>Tanzania</p>
                                </div>
                                <div class="theme_two_box_content">
                                    <h4><a href="tour-details.html">10 Days Lemosho Route</a></h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="theme_common_box_two img_hover">
                                <div class="theme_two_box_img">
                                    <a href="tour-details.html"><img src="assets/img/tab-img/Guide Kili .png" alt="img"></a>
                                    <p><i class="fas fa-map-marker-alt"></i>Tanzania</p>
                                ...
                                <div class="theme_two_box_content">
                                    <h4><a href="tour-details.html">9 Days Machame Route</a></h4>
                                    <p><span class="review_rating">4.8/5 Excellent</span> <span
                                            class="review_count">(1214
                                            reviewes)</span></p>
                                    <h3><span></span></h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="theme_common_box_two img_hover">
                                <div class="theme_two_box_img">
                                    <a href="tour-details.html"><img src="assets/img/tab-img/Zanzibar.png" alt="img"></a>
                                    <p><i class="fas fa-map-marker-alt"></i>Tanzania</p>
                                </div>
                                <div class="theme_two_box_content">
                                    <h4><a href="tour-details.html">6 Days Restful</a></h4>
                                    <p><span class="review_rating">4.8/5 Excellent</span> <span
                                            class="review_count">(1214
                                            reviewes)</span></p>
                                    <h3><span></span></h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="theme_common_box_two img_hover">
                                <div class="theme_two_box_img">
                                    <a href="tour-details.html"><img src="assets/img/tab-img/Masai com.png" alt="img"></a>
                                    <p><i class="fas fa-map-marker-alt"></i>Tanzania</p>
                                    <div class="discount_tab">
                                        <span></span>
                                    </div>
                                ...
                                <div class="theme_two_box_content">
                                    <h4><a href="tour-details.html"> 8 Days Ronngai Route</a></h4>
                                    <p><span class="review_rating">4.8/5 Excellent</span> <span
                                            class="review_count">(1214
                                            reviewes)</span></p>
                                    <h3><span></span></h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="theme_common_box_two img_hover">
                                <div class="theme_two_box_img">
                                    <a href="tour-details.html"><img src="assets/img/tab-img/elephant about.png" alt="img"></a>
                                    <p><i class="fas fa-map-marker-alt"></i>Tanzania</p>
                                </div>
                                <div class="theme_two_box_content">
                                    <h4><a href="tour-details.html">7 Days Marangu Route</a></h4>
                                    <p><span class="review_rating">4.8/5 Excellent</span> <span
                                            class="review_count">(1214
                                            reviewes)</span></p>
                                    <h3><span></span></h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="theme_common_box_two img_hover">
                                <div class="theme_two_box_img">
                                    <a href="tour-details.html"><img src="assets/img/tab-img/ANtelop1.png" alt="img"></a>
