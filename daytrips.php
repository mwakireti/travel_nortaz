...
<head>
    ...
    <!-- Title -->
    <title> Nortaz Safari LTD - Climb & Trekk</title>
    <!-- Bootstrap css -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        <h2>Day trips search result</h2>
                        <ul>
                            <li><a href="home">Home</a></li>
                            <li><span><i class="fas fa-circle"></i></span> Day Trips</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="section_heading_center">
                        <h2>Available Day Trip tours</h2>
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="theme_common_box_two img_hover">
                            ...
                            <div class="theme_two_box_content">
                                <h4><a href="10days-lemosho-route.php">Go Karting</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="theme_common_box_two img_hover">
                            ...
                            <div class="theme_two_box_content">
                                <h4><a href="tour-details">Chemka Hot Spring</a></h4>
                                <p><span class="review_rating">4.8/5 Excellent</span> <span
                                        class="review_count">(1214
                                        reviewes)</span></p>
                                <h3><span></span></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="theme_common_box_two img_hover">
                            ...
                            <div class="theme_two_box_content">
                                <h4><a href="tour-details">Marangu Waterfalls.</a></h4>
                                <p><span class="review_rating">4.8/5 Excellent</span> <span
                                        class="review_count">(1214
                                        reviewes)</span></p>
                                <h3><span></span></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="theme_common_box_two img_hover">
                            <div class="theme_two_box_img">
                                <a href="tour-details.php"><img src="assets/img/tour/popular-2.png" alt="img"></a>
                                <p><i class="fas fa-map-marker-alt"></i>Tanzania</p>
                                <div class="discount_tab">
                                    <span></span>
                                </div>
                            ...
                            <div class="theme_two_box_content">
                                <h4><a href="tour-details"> BBQ & STREET FOOD</a></h4>
                                <p><span class="review_rating">4.8/5 Excellent</span> <span
                                        class="review_count">(1214
                                        reviewes)</span></p>
                                <h3><span></span></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="theme_common_box_two img_hover">
                            ...
                            <div class="theme_two_box_content">
                                <h4><a href="tour-details">Canoeing & Birdwatching.</a></h4>
                                <p><span class="review_rating">4.8/5 Excellent</span> <span
                                        class="review_count">(1214
                                        reviewes)</span></p>
                                <h3><span></span></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="theme_common_box_two img_hover">
                            ...
                            <div class="theme_two_box_content">
                                <h4><a href="tour-details">City Tour </a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="theme_common_box_two img_hover">
                            ...
                            <div class="theme_two_box_content">
                                <h4><a href="tour-details">Zipline </a></h4>
                                <p><span class="review_rating"></span> <span
                                        class="review_count"></span></p>
                                <h3><span></span></h3>
                            </div>
