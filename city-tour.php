                ...
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        ...
                        <ul>
                            ...
                            <li><span><i class="fas fa-circle"></i></span> CITY TOUR.</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tour_details_leftside_wrapper">
                        <div class="tour_details_heading_wrapper">
                            <div class="tour_details_top_heading">
                                ...
                                <h5><i class="fas fa-map-marker-alt"></i> CITY TOUR.
                                </h5>
                            </div>
                        ...
                        <div class="tour_details_boxed">
                            ...
                            <div class="tour_details_boxed_inner">
                                <p> Getting to be familiar with the most tourist city in East Africa, is a great privilege! Nortaz Safari will take you around all the important places with unique history that you need to know. Getting the details, culture and patterns of a specific place will divert your experiences into reality that will make you feel more than just a tourist. Tour will take you from the governmental buildings that hold the history of the city to the cultural activities in the city. We will go through Arusha museum, Local food market, Maasai market, Second-hand clothes market, Shopping malls, Tanzanite shopping house, Cultural heritage house, International conference center 
                                    Then after feeding both your eyes and mind, it's a time to sit down and allow all of the information and new things you have learned about this beautiful city to sink in your mind while enjoying a delicious lunch.</p>
                                <!-- <p>
