                ...
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        ...
                        <ul>
                            ...
                            <li><span><i class="fas fa-circle"></i></span> ZIPLINE.</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tour_details_leftside_wrapper">
                        <div class="tour_details_heading_wrapper">
                            <div class="tour_details_top_heading">
                                ...
                                <h5><i class="fas fa-map-marker-alt"></i> ZIPLINE.
                                </h5>
                            </div>
                        ...
                        <div class="tour_details_boxed">
                            ...
                            <div class="tour_details_boxed_inner">
                                <p> This is one of the most popular things to do while in Arusha. We take a drive toward the most famous Park of Serengeti, after 1.30hr we arrive at Mto wa mbu, where our Zipline activities will be held.
                                    Zipline is nestled at the base of the great rift valley wall, offering stunning views of the surrounding lakes, wetlands, maasai steppe and the rift valley. It's a suitable place for both team building activities and leisure themes. You will enjoy the safety orientation, scenic transfer between the majestic baobab trees, maasai land and a fun zip adventure.After the zipline adventure, you can also add on a maasai culture trip that will happen down to the maasai village and experience their ways of life, dances, songs and learn more about this biggest tribe in East Africa.</p>
                                <!-- <p>
